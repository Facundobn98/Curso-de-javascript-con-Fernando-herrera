...
//(strings y números).Mostrá por consola:
/**
...
/**
 * Dado este arreglo:
 * let colores = ['rojo', 'verde', 'azul', 'amarillo']; Mostrá por consola:
...
let suma = (datos[2][0] + datos[2][1] * 1)
...
let borradas = tareas.slice(posicion, 2)
...
let listaNumeros = numeros.slice(posicion7, 4);
